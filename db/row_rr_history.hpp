...
namespace adns
{
    namespace db
    {
        class row_rr_history final : public row
        {
        public:
             ...
             * destructor
             */
            virtual ~row_rr_history();

            /**
             * get all rows from the table
             */
            static std::vector<std::shared_ptr<row_rr_history>> get_rows(connection &conn);

            static std::shared_ptr<row_rr_history> get_by_rr_history_id(connection &c, uuid rr_history_id);
            static std::vector<std::shared_ptr<row_rr_history>> get_by_zone_id_sequence_number(connection &c, uuid zone_id, uint sequence_number);

            static void delete_by_rr_history_id(connection &c, uuid rr_history_id);
            static void delete_by_zone_id_sequence_number(connection &c, uuid zone_id, uint sequence_number);

            uuid get_rr_history_id() const;
            std::string get_full_record() const;
            uuid get_zone_id() const;
            uint get_sequence_number() const;
            std::string get_action() const;

            void set_rr_history_id(uuid v);
            void set_full_record(std::string v);
            void set_zone_id(uuid v);
            void set_sequence_number(uint v);
            void set_action(std::string v);
        ...
        private:
            ...
            uuid m_rr_history_id;
            std::string m_full_record;
            uuid m_zone_id;
