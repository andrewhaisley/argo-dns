...
namespace adns
{
    namespace db
    {
        class row_rr_ptr final : public row
        {
        public:
             ...
             */
            static std::vector<std::shared_ptr<row_rr_ptr>> get_rows(connection &conn);

            static std::shared_ptr<row_rr_ptr> get_by_rr_ptr_id(connection &c, uuid rr_ptr_id);
            static std::vector<std::shared_ptr<row_rr_ptr>> get_by_zone_id(connection &c, uuid zone_id);

            static void delete_by_rr_ptr_id(connection &c, uuid rr_ptr_id);
            static void delete_by_zone_id(connection &c, uuid zone_id);

            std::string get_dname() const;
            std::string get_name() const;
            uuid get_rr_ptr_id() const;
            uint get_ttl() const;
            uuid get_zone_id() const;

            void set_dname(std::string v);
            void set_name(std::string v);
            void set_rr_ptr_id(uuid v);
            void set_ttl(uint v);
