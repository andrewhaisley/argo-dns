...
namespace adns
{
    namespace db
    {
        class row_rr_dhcid final : public row
        {
        public:
             ...
             * destructor
             */
            virtual ~row_rr_dhcid();

            /**
             * get all rows from the table
             */
            static std::vector<std::shared_ptr<row_rr_dhcid>> get_rows(connection &conn);

            static std::shared_ptr<row_rr_dhcid> get_by_rr_dhcid_id(connection &c, uuid rr_dhcid_id);
            static std::vector<std::shared_ptr<row_rr_dhcid>> get_by_zone_id(connection &c, uuid zone_id);

            static void delete_by_rr_dhcid_id(connection &c, uuid rr_dhcid_id);
            static void delete_by_zone_id(connection &c, uuid zone_id);

            std::string get_contents() const;
            std::string get_name() const;
            uuid get_rr_dhcid_id() const;
            uint get_ttl() const;
            uuid get_zone_id() const;

            void set_contents(std::string v);
            void set_name(std::string v);
            void set_rr_dhcid_id(uuid v);
            void set_ttl(uint v);
