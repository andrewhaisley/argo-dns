...
namespace adns
{
    namespace db
    {
        class row_control_server final : public row
        {
        public:
             ...
             * destructor
             */
            virtual ~row_control_server();

            /**
             * get all rows from the table
             */
            static std::vector<std::shared_ptr<row_control_server>> get_rows(connection &conn);

            static std::shared_ptr<row_control_server> get_by_server_id(connection &c, uuid server_id);
            static std::vector<std::shared_ptr<row_control_server>> get_by_address_list_id(connection &c, uuid address_list_id);
            ...
            uint get_maximum_payload_size() const;
            ...
            void set_maximum_payload_size(uint v);
