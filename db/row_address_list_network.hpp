...
namespace adns
{
    namespace db
    {
        class row_address_list_network final : public row
        {
        public:
             ...
             */
            row_address_list_network();

            /**
             * destructor
             */
            virtual ~row_address_list_network();

            /**
             * get all rows from the table
             */
            static std::vector<std::shared_ptr<row_address_list_network>> get_rows(connection &conn);

            static std::shared_ptr<row_address_list_network> get_by_address_list_network_id(connection &c, uuid address_list_network_id);
            static std::vector<std::shared_ptr<row_address_list_network>> get_by_address_list_id(connection &c, uuid address_list_id);

            static void delete_by_address_list_network_id(connection &c, uuid address_list_network_id);
            static void delete_by_address_list_id(connection &c, uuid address_list_id);

            uuid get_address_list_id() const;
            uuid get_address_list_network_id() const;
            std::string get_cidr_address() const;

            void set_address_list_id(uuid v);
            void set_address_list_network_id(uuid v);
            void set_cidr_address(std::string v);
        ...
        private:
            ...
            uuid m_address_list_network_id;
            std::string m_cidr_address;
