...
namespace adns
{
    namespace db
    {
        class row_rr_mx final : public row
        {
        public:
             ...
             */
            static std::vector<std::shared_ptr<row_rr_mx>> get_rows(connection &conn);

            static std::shared_ptr<row_rr_mx> get_by_rr_mx_id(connection &c, uuid rr_mx_id);
            static std::vector<std::shared_ptr<row_rr_mx>> get_by_zone_id(connection &c, uuid zone_id);

            static void delete_by_rr_mx_id(connection &c, uuid rr_mx_id);
            static void delete_by_zone_id(connection &c, uuid zone_id);

            std::string get_exchange() const;
            std::string get_name() const;
            int get_preference() const;
            uuid get_rr_mx_id() const;
            uint get_ttl() const;
            uuid get_zone_id() const;

            void set_exchange(std::string v);
            void set_name(std::string v);
            void set_preference(int v);
            void set_rr_mx_id(uuid v);
            void set_ttl(uint v);
