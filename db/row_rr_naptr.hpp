...
namespace adns
{
    namespace db
    {
        class row_rr_naptr final : public row
        {
        public:
             ...
             * destructor
             */
            virtual ~row_rr_naptr();

            /**
             * get all rows from the table
             */
            static std::vector<std::shared_ptr<row_rr_naptr>> get_rows(connection &conn);

            static std::shared_ptr<row_rr_naptr> get_by_rr_naptr_id(connection &c, uuid rr_naptr_id);
            static std::vector<std::shared_ptr<row_rr_naptr>> get_by_zone_id(connection &c, uuid zone_id);

            static void delete_by_rr_naptr_id(connection &c, uuid rr_naptr_id);
            static void delete_by_zone_id(connection &c, uuid zone_id);

            std::string get_flags() const;
            std::string get_name() const;
            uint get_naptr_order() const;
            std::string get_naptr_regexp() const;
            uint get_preference() const;
            std::string get_replacement() const;
            uuid get_rr_naptr_id() const;
            std::string get_services() const;
            uint get_ttl() const;
            uuid get_zone_id() const;

            void set_flags(std::string v);
            void set_name(std::string v);
            void set_naptr_order(uint v);
            void set_naptr_regexp(std::string v);
            void set_preference(uint v);
            void set_replacement(std::string v);
            void set_rr_naptr_id(uuid v);
            void set_services(std::string v);
            void set_ttl(uint v);
