...
namespace adns
{
    namespace db
    {
        class row_rr_cert final : public row
        {
        public:
             ...
             */
            static std::vector<std::shared_ptr<row_rr_cert>> get_rows(connection &conn);

            static std::shared_ptr<row_rr_cert> get_by_rr_cert_id(connection &c, uuid rr_cert_id);
            static std::vector<std::shared_ptr<row_rr_cert>> get_by_zone_id(connection &c, uuid zone_id);

            static void delete_by_rr_cert_id(connection &c, uuid rr_cert_id);
            static void delete_by_zone_id(connection &c, uuid zone_id);

            octet get_algorithm() const;
            std::string get_certificate() const;
            uint get_certificate_type() const;
            uint get_key_tag() const;
            std::string get_name() const;
            uuid get_rr_cert_id() const;
            uint get_ttl() const;
            uuid get_zone_id() const;

            void set_algorithm(octet v);
            void set_certificate(std::string v);
            void set_certificate_type(uint v);
            void set_key_tag(uint v);
            void set_name(std::string v);
            void set_rr_cert_id(uuid v);
            void set_ttl(uint v);
