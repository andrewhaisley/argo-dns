...
namespace adns
{
    namespace db
    {
        class row_horizon final : public row
        {
        public:
             ...
             */
            static std::vector<std::shared_ptr<row_horizon>> get_rows(connection &conn);

            static std::shared_ptr<row_horizon> get_by_horizon_id(connection &c, uuid horizon_id);
            static std::vector<std::shared_ptr<row_horizon>> get_by_address_list_id(connection &c, uuid address_list_id);
            ...
            bool get_allow_recursion() const;
            uuid get_horizon_id() const;
            uint get_check_order() const;

            void set_address_list_id(uuid v);
            void set_allow_recursion(bool v);
            void set_horizon_id(uuid v);
            void set_check_order(uint v);
