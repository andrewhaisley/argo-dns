...
void row_dns_server::init_static()
{
    if (!o_initialised)
    {
        ...
        if (!o_initialised)
        {
            ...
            o_columns.push_back(column(column::uint_e, "forward_cache_max_age_seconds", 26, false));
            o_columns.push_back(column(column::uint_e, "forward_cache_max_entries", 27, false));
            o_columns.push_back(column(column::uint_e, "forward_cache_garbage_collect_pct", 28, false));
