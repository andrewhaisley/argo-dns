...
namespace adns
{
    namespace db
    {
        class row_rr_svcb final : public row
        {
        public:
             ...
             */
            static std::vector<std::shared_ptr<row_rr_svcb>> get_rows(connection &conn);

            static std::shared_ptr<row_rr_svcb> get_by_rr_svcb_id(connection &c, uuid rr_svcb_id);
            static std::vector<std::shared_ptr<row_rr_svcb>> get_by_zone_id(connection &c, uuid zone_id);

            static void delete_by_rr_svcb_id(connection &c, uuid rr_svcb_id);
            static void delete_by_zone_id(connection &c, uuid zone_id);

            std::string get_name() const;
            uint get_priority() const;
            uuid get_rr_svcb_id() const;
