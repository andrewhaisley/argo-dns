...
namespace adns
{
    namespace db
    {
        class row_rr_aaaa final : public row
        {
        public:
             ...
             */
            static std::vector<std::shared_ptr<row_rr_aaaa>> get_rows(connection &conn);

            static std::shared_ptr<row_rr_aaaa> get_by_rr_aaaa_id(connection &c, uuid rr_aaaa_id);
            static std::vector<std::shared_ptr<row_rr_aaaa>> get_by_zone_id(connection &c, uuid zone_id);

            static void delete_by_rr_aaaa_id(connection &c, uuid rr_aaaa_id);
            static void delete_by_zone_id(connection &c, uuid zone_id);

            std::string get_ip6_addr() const;
            std::string get_name() const;
            uuid get_rr_aaaa_id() const;
            uint get_ttl() const;
            uuid get_zone_id() const;

            void set_ip6_addr(std::string v);
            void set_name(std::string v);
            void set_rr_aaaa_id(uuid v);
            void set_ttl(uint v);
