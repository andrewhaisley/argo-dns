...
namespace adns
{
    namespace db
    {
        class row_root_server final : public row
        {
        public:
             ...
             * destructor
             */
            virtual ~row_root_server();

            /**
             * get all rows from the table
             */
            static std::vector<std::shared_ptr<row_root_server>> get_rows(connection &conn);

            static std::shared_ptr<row_root_server> get_by_root_server_id(connection &c, uuid root_server_id);

            static void delete_by_root_server_id(connection &c, uuid root_server_id);

            uint get_addr_ttl() const;
            std::string get_ip_address() const;
            datetime get_last_contact_date_time() const;
            std::string get_name() const;
            uint get_ns_ttl() const;
            uuid get_root_server_id() const;

            void set_addr_ttl(uint v);
            void set_ip_address(std::string v);
            void set_last_contact_date_time(datetime v);
            void set_name(std::string v);
            void set_ns_ttl(uint v);
            void set_root_server_id(uuid v);
        ...
        private:
            ...
            datetime m_last_contact_date_time;
            std::string m_name;
            uint m_ns_ttl;
            uuid m_root_server_id;
