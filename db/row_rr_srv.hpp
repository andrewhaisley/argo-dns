...
namespace adns
{
    namespace db
    {
        class row_rr_srv final : public row
        {
        public:
             ...
             */
            static std::vector<std::shared_ptr<row_rr_srv>> get_rows(connection &conn);

            static std::shared_ptr<row_rr_srv> get_by_rr_srv_id(connection &c, uuid rr_srv_id);
            static std::vector<std::shared_ptr<row_rr_srv>> get_by_zone_id(connection &c, uuid zone_id);

            static void delete_by_rr_srv_id(connection &c, uuid rr_srv_id);
            static void delete_by_zone_id(connection &c, uuid zone_id);

            std::string get_name() const;
            uint get_port() const;
            uint get_priority() const;
            uuid get_rr_srv_id() const;
            ...
            void set_rr_srv_id(uuid v);
            void set_target(std::string v);
            void set_ttl(uint v);
            void set_weight(uint v);
