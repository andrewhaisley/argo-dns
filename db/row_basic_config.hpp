...
namespace adns
{
    namespace db
    {
        class row_basic_config final : public row
        {
        public:
             ...
             * destructor
             */
            virtual ~row_basic_config();

            /**
             * get all rows from the table
             */
            static std::vector<std::shared_ptr<row_basic_config>> get_rows(connection &conn);

            static std::shared_ptr<row_basic_config> get_by_config_id(connection &c, uuid config_id);

            static void delete_by_config_id(connection &c, uuid config_id);

            uuid get_config_id() const;
            std::string get_name() const;
            std::string get_value() const;

            void set_config_id(uuid v);
