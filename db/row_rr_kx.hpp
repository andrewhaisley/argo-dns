...
namespace adns
{
    namespace db
    {
        class row_rr_kx final : public row
        {
        public:
             ...
             */
            static std::vector<std::shared_ptr<row_rr_kx>> get_rows(connection &conn);

            static std::shared_ptr<row_rr_kx> get_by_rr_kx_id(connection &c, uuid rr_kx_id);
            static std::vector<std::shared_ptr<row_rr_kx>> get_by_zone_id(connection &c, uuid zone_id);

            static void delete_by_rr_kx_id(connection &c, uuid rr_kx_id);
            static void delete_by_zone_id(connection &c, uuid zone_id);

            std::string get_exchanger() const;
            std::string get_name() const;
            uint get_preference() const;
            uuid get_rr_kx_id() const;
            uint get_ttl() const;
            uuid get_zone_id() const;

            void set_exchanger(std::string v);
            void set_name(std::string v);
            void set_preference(uint v);
            void set_rr_kx_id(uuid v);
            void set_ttl(uint v);
