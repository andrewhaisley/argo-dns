...
namespace adns
{
    namespace db
    {
        class row_rr_soa final : public row
        {
        public:
             ...
             */
            static std::vector<std::shared_ptr<row_rr_soa>> get_rows(connection &conn);

            static std::shared_ptr<row_rr_soa> get_by_rr_soa_id(connection &c, uuid rr_soa_id);
            static std::vector<std::shared_ptr<row_rr_soa>> get_by_zone_id(connection &c, uuid zone_id);

            static void delete_by_rr_soa_id(connection &c, uuid rr_soa_id);
            ...
            uuid get_rr_soa_id() const;
            uint get_serial() const;
            uint get_ttl() const;
            uuid get_zone_id() const;

            void set_expire(int v);
            void set_minimum(uint v);
            void set_mname(std::string v);
            void set_name(std::string v);
            void set_refresh(int v);
            void set_retry(int v);
            void set_rname(std::string v);
            void set_rr_soa_id(uuid v);
            void set_serial(uint v);
            void set_ttl(uint v);
