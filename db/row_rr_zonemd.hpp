...
namespace adns
{
    namespace db
    {
        class row_rr_zonemd final : public row
        {
        public:
             ...
             * destructor
             */
            virtual ~row_rr_zonemd();

            /**
             * get all rows from the table
             */
            static std::vector<std::shared_ptr<row_rr_zonemd>> get_rows(connection &conn);

            static std::shared_ptr<row_rr_zonemd> get_by_rr_zonemd_id(connection &c, uuid rr_zonemd_id);
            static std::vector<std::shared_ptr<row_rr_zonemd>> get_by_zone_id(connection &c, uuid zone_id);

            static void delete_by_rr_zonemd_id(connection &c, uuid rr_zonemd_id);
            static void delete_by_zone_id(connection &c, uuid zone_id);

            octet get_algorithm() const;
            std::string get_digest() const;
            std::string get_name() const;
            uuid get_rr_zonemd_id() const;
            octet get_scheme() const;
            uint get_soa_serial() const;
            uint get_ttl() const;
            uuid get_zone_id() const;

            void set_algorithm(octet v);
            void set_digest(std::string v);
            void set_name(std::string v);
            void set_rr_zonemd_id(uuid v);
            void set_scheme(octet v);
