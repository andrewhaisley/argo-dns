...
namespace adns
{
    namespace db
    {
        class row_schema_version final : public row
        {
        public:
             ...
             * destructor
             */
            virtual ~row_schema_version();

            /**
             * get all rows from the table
             */
            static std::vector<std::shared_ptr<row_schema_version>> get_rows(connection &conn);

            static std::shared_ptr<row_schema_version> get_by_schema_version_id(connection &c, uuid schema_version_id);

            static void delete_by_schema_version_id(connection &c, uuid schema_version_id);

            uuid get_schema_version_id() const;
            std::string get_version_string() const;

            void set_schema_version_id(uuid v);
