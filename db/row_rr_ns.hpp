...
namespace adns
{
    namespace db
    {
        class row_rr_ns final : public row
        {
        public:
             ...
             */
            static std::vector<std::shared_ptr<row_rr_ns>> get_rows(connection &conn);

            static std::shared_ptr<row_rr_ns> get_by_rr_ns_id(connection &c, uuid rr_ns_id);
            static std::vector<std::shared_ptr<row_rr_ns>> get_by_zone_id(connection &c, uuid zone_id);

            static void delete_by_rr_ns_id(connection &c, uuid rr_ns_id);
            static void delete_by_zone_id(connection &c, uuid zone_id);

            std::string get_name() const;
            std::string get_nsdname() const;
            uuid get_rr_ns_id() const;
            uint get_ttl() const;
            uuid get_zone_id() const;

            void set_name(std::string v);
            void set_nsdname(std::string v);
            void set_rr_ns_id(uuid v);
            void set_ttl(uint v);
