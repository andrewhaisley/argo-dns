...
namespace adns
{
    namespace db
    {
        class row_rr_caa final : public row
        {
        public:
             ...
             */
            static std::vector<std::shared_ptr<row_rr_caa>> get_rows(connection &conn);

            static std::shared_ptr<row_rr_caa> get_by_rr_caa_id(connection &c, uuid rr_caa_id);
            static std::vector<std::shared_ptr<row_rr_caa>> get_by_zone_id(connection &c, uuid zone_id);

            static void delete_by_rr_caa_id(connection &c, uuid rr_caa_id);
            static void delete_by_zone_id(connection &c, uuid zone_id);

            std::string get_contents() const;
            octet get_flags() const;
            std::string get_name() const;
            uuid get_rr_caa_id() const;
            std::string get_tag() const;
            uint get_ttl() const;
            uuid get_zone_id() const;

            void set_contents(std::string v);
            void set_flags(octet v);
            void set_name(std::string v);
            void set_rr_caa_id(uuid v);
            void set_tag(std::string v);
            void set_ttl(uint v);
