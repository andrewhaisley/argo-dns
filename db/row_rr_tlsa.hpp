...
namespace adns
{
    namespace db
    {
        class row_rr_tlsa final : public row
        {
        public:
             ...
             */
            static std::vector<std::shared_ptr<row_rr_tlsa>> get_rows(connection &conn);

            static std::shared_ptr<row_rr_tlsa> get_by_rr_tlsa_id(connection &c, uuid rr_tlsa_id);
            static std::vector<std::shared_ptr<row_rr_tlsa>> get_by_zone_id(connection &c, uuid zone_id);

            static void delete_by_rr_tlsa_id(connection &c, uuid rr_tlsa_id);
            static void delete_by_zone_id(connection &c, uuid zone_id);

            octet get_certifcate_usage() const;
            std::string get_certificate_association() const;
            octet get_matching_type() const;
            std::string get_name() const;
            uuid get_rr_tlsa_id() const;
            octet get_selector() const;
            uint get_ttl() const;
            uuid get_zone_id() const;

            void set_certifcate_usage(octet v);
            void set_certificate_association(std::string v);
            void set_matching_type(octet v);
            void set_name(std::string v);
            void set_rr_tlsa_id(uuid v);
            void set_selector(octet v);
            void set_ttl(uint v);
        ...
        private:
            ...
            std::string m_certificate_association;
