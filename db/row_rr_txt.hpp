...
namespace adns
{
    namespace db
    {
        class row_rr_txt final : public row
        {
        public:
             ...
             */
            static std::vector<std::shared_ptr<row_rr_txt>> get_rows(connection &conn);

            static std::shared_ptr<row_rr_txt> get_by_rr_txt_id(connection &c, uuid rr_txt_id);
            static std::vector<std::shared_ptr<row_rr_txt>> get_by_zone_id(connection &c, uuid zone_id);

            static void delete_by_rr_txt_id(connection &c, uuid rr_txt_id);
            static void delete_by_zone_id(connection &c, uuid zone_id);

            std::string get_name() const;
            uuid get_rr_txt_id() const;
            uint get_ttl() const;
            std::string get_txt() const;
            uuid get_zone_id() const;

            void set_name(std::string v);
            void set_rr_txt_id(uuid v);
            void set_ttl(uint v);
            void set_txt(std::string v);
