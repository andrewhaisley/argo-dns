...
namespace adns
{
    namespace db
    {
        class row_dns_client final : public row
        {
        public:
             ...
             * destructor
             */
            virtual ~row_dns_client();

            /**
             * get all rows from the table
             */
            static std::vector<std::shared_ptr<row_dns_client>> get_rows(connection &conn);

            static std::shared_ptr<row_dns_client> get_by_client_id(connection &c, uuid client_id);

            static void delete_by_client_id(connection &c, uuid client_id);

            uuid get_client_id() const;
            uint get_connect_tcp_timeout_ms() const;
            uint get_num_parallel_udp() const;
            uint get_read_tcp_timeout_ms() const;
            uint get_server_port() const;
            uint get_total_timeout_ms() const;
            uint get_udp_timeout_ms() const;
            bool get_use_ip4() const;
            bool get_use_ip6() const;
            bool get_use_tcp() const;
            bool get_use_udp() const;
            uint get_wait_udp_response_ms() const;
            uint get_write_tcp_timeout_ms() const;

            void set_client_id(uuid v);
            void set_connect_tcp_timeout_ms(uint v);
            void set_num_parallel_udp(uint v);
            void set_read_tcp_timeout_ms(uint v);
            void set_server_port(uint v);
            void set_total_timeout_ms(uint v);
            void set_udp_timeout_ms(uint v);
            void set_use_ip4(bool v);
            void set_use_ip6(bool v);
            void set_use_tcp(bool v);
            void set_use_udp(bool v);
            void set_wait_udp_response_ms(uint v);
            void set_write_tcp_timeout_ms(uint v);
        ...
        private:
            ...
            uuid m_client_id;
            uint m_connect_tcp_timeout_ms;
            uint m_num_parallel_udp;
            uint m_read_tcp_timeout_ms;
            uint m_server_port;
            uint m_total_timeout_ms;
            uint m_udp_timeout_ms;
            bool m_use_ip4;
            bool m_use_ip6;
            bool m_use_tcp;
            bool m_use_udp;
            uint m_wait_udp_response_ms;
            uint m_write_tcp_timeout_ms;
