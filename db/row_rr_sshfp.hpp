...
namespace adns
{
    namespace db
    {
        class row_rr_sshfp final : public row
        {
        public:
             ...
             * destructor
             */
            virtual ~row_rr_sshfp();

            /**
             * get all rows from the table
             */
            static std::vector<std::shared_ptr<row_rr_sshfp>> get_rows(connection &conn);

            static std::shared_ptr<row_rr_sshfp> get_by_rr_sshfp_id(connection &c, uuid rr_sshfp_id);
            static std::vector<std::shared_ptr<row_rr_sshfp>> get_by_zone_id(connection &c, uuid zone_id);

            static void delete_by_rr_sshfp_id(connection &c, uuid rr_sshfp_id);
            ...
            uuid get_rr_sshfp_id() const;
            uint get_ttl() const;
            uuid get_zone_id() const;

            void set_algorithm(octet v);
            void set_fingerprint(std::string v);
            void set_fp_type(octet v);
            void set_name(std::string v);
            void set_rr_sshfp_id(uuid v);
            void set_ttl(uint v);
