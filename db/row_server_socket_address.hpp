...
namespace adns
{
    namespace db
    {
        class row_server_socket_address final : public row
        {
        public:
             ...
             */
            row_server_socket_address();

            /**
             * destructor
             */
            virtual ~row_server_socket_address();

            /**
             * get all rows from the table
             */
            static std::vector<std::shared_ptr<row_server_socket_address>> get_rows(connection &conn);

            static std::shared_ptr<row_server_socket_address> get_by_server_socket_address_id(connection &c, uuid server_socket_address_id);
            static std::vector<std::shared_ptr<row_server_socket_address>> get_by_server_id(connection &c, uuid server_id);

            static void delete_by_server_socket_address_id(connection &c, uuid server_socket_address_id);
            static void delete_by_server_id(connection &c, uuid server_id);

            std::string get_ip_address() const;
            uint get_port() const;
            uuid get_server_id() const;
            uuid get_server_socket_address_id() const;

            void set_ip_address(std::string v);
            void set_port(uint v);
            void set_server_id(uuid v);
            void set_server_socket_address_id(uuid v);
        ...
        private:
            ...
            uint m_port;
            uuid m_server_id;
            uuid m_server_socket_address_id;
