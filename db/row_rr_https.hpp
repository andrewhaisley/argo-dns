...
namespace adns
{
    namespace db
    {
        class row_rr_https final : public row
        {
        public:
             ...
             * destructor
             */
            virtual ~row_rr_https();

            /**
             * get all rows from the table
             */
            static std::vector<std::shared_ptr<row_rr_https>> get_rows(connection &conn);

            static std::shared_ptr<row_rr_https> get_by_rr_https_id(connection &c, uuid rr_https_id);
            static std::vector<std::shared_ptr<row_rr_https>> get_by_zone_id(connection &c, uuid zone_id);

            static void delete_by_rr_https_id(connection &c, uuid rr_https_id);
            static void delete_by_zone_id(connection &c, uuid zone_id);

            std::string get_name() const;
            uint get_priority() const;
            uuid get_rr_https_id() const;
            std::string get_svcparams() const;
            std::string get_target() const;
            uint get_ttl() const;
            uuid get_zone_id() const;

            void set_name(std::string v);
            void set_priority(uint v);
            void set_rr_https_id(uuid v);
            void set_svcparams(std::string v);
            void set_target(std::string v);
            void set_ttl(uint v);
