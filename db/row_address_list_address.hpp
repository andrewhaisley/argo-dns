...
namespace adns
{
    namespace db
    {
        class row_address_list_address final : public row
        {
        public:
             ...
             */
            row_address_list_address();

            /**
             * destructor
             */
            virtual ~row_address_list_address();

            /**
             * get all rows from the table
             */
            static std::vector<std::shared_ptr<row_address_list_address>> get_rows(connection &conn);

            static std::shared_ptr<row_address_list_address> get_by_address_list_address_id(connection &c, uuid address_list_address_id);
            static std::vector<std::shared_ptr<row_address_list_address>> get_by_address_list_id(connection &c, uuid address_list_id);

            static void delete_by_address_list_address_id(connection &c, uuid address_list_address_id);
            static void delete_by_address_list_id(connection &c, uuid address_list_id);

            uuid get_address_list_address_id() const;
            uuid get_address_list_id() const;
            std::string get_ip_address() const;

            void set_address_list_address_id(uuid v);
        ...
        private:
            ...
            uuid m_address_list_address_id;
