...
def run_rr_tests():
    ...
    for t in rr_tests:
        ...
        bind_res_file = results_dir + '/test-%s-bind-rr-result.txt' % n
        command = bind + ' ' + t + '>' + bind_res_file
        os.system(command)
...
def run_zone_transfer_tests():
    ...
    for t in zone_transfer_tests:
        ...
        bind_res_file = results_dir + '/test-%s-bind-transfer-result.txt' % n
        command = bind + ' ' + t + " | grep -v ';' | sort > " + bind_res_file
        os.system(command)
